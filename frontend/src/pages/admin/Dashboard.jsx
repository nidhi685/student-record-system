  ...
  const getDashboard = async () => {
    try {
      ...
      setDashboard({
        ...
        averageMarks: res.data.averageMarks || 0,
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-blue-600 text-white rounded-2xl shadow-md p-6">
            <div className="flex items-center justify-between">
              ...
              <FaUserGraduate size={45} className="opacity-80" />
            </div>
          </div>
          ...
          <div className="bg-green-600 text-white rounded-2xl shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-medium">Marks Records</h2>
              ...
              <FaClipboardList size={45} className="opacity-80" />
            </div>
          </div>
          ...
          <div className="bg-purple-600 text-white rounded-2xl shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-medium">Average Marks</h2>
              ...
              <FaChartBar size={45} className="opacity-80" />
            </div>
          </div>
          ...
          <div className="bg-orange-500 text-white rounded-2xl shadow-md p-6">
            <div className="flex items-center justify-between">
              ...
              <FaBook size={45} className="opacity-80" />
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 bg-white rounded-2xl shadow-md p-6">
          ...
          {dashboard.recentStudents?.length > 0 ? (
            ...
            <p className="text-gray-500">No recent students found</p>
          )}
        </div>
      </div>
    </Layout>
